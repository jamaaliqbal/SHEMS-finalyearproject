...
SECRET_KEY = 'django-insecure-(r-c2q*&d9)+fi)n_88d!iz2=mv^-jx9m@98hez3w(i#t=vlvp'
...
AUTHENTICATION_BACKENDS = [
    ...
    'energy.backend.MyBackend',  # Custom backend for email authentication
]

load_dotenv()

SOLAX_API_TOKEN = os.getenv("SOLAX_API_TOKEN")
SOLAX_API_URL = os.getenv("SOLAX_API_URL")
SOLAX_WIFI_SNS = [os.getenv("SOLAX_WIFI_SNS", "")]

OCTOPUS_API_URL = os.getenv("OCTOPUS_API_URL")
OCTOPUS_API_KEY = os.getenv("OCTOPUS_API_KEY")
OCTOPUS_MPAN = os.getenv("OCTOPUS_MPAN")
OCTOPUS_SERIAL = os.getenv("OCTOPUS_SERIAL")
